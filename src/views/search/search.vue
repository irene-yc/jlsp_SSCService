<template>
 <!-- 工作计划 -->
    <div class="special-audit">
      <el-row>
        <el-col :span="6" class="search-handle">
          <span>搜索：</span>
          <el-input v-model="auditName" size="small" placeholder="请输入管理机构" style="width:180px"></el-input>
          <el-button type="primary" style="height:32px;line-height:5px;margin-left:10px" @click="searchHandle">
          搜索
          </el-button>
        </el-col>
      </el-row>
        ...
        <el-dialog title="新建审计报告" :visible.sync="dialogFormVisible">
            <el-form :model="formData">
                ...
                <el-form-item label="被审计单位" :label-width="formLabelWidth" prop="auditDeptId">
                        ...
                        <!-- 其他用户都必须有主管部门 -->
                        <!-- <el-select  v-model="loginInfo.deptId" disabled style="width:400px">
